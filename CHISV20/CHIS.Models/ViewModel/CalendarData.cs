...
namespace CHIS.Models.ViewModel
{
    ...
    public class CustomerRegisterItem
    {
        ...
        internal CHIS.Models.vwCHIS_Register register = null;
        ...
        public CustomerRegisterItem(CHIS.Models.vwCHIS_Register vwCHIS_Register)
        {
            this.register = vwCHIS_Register;
        }
        //设置是否过期
        public static string _setStatus(CHIS.Models.vwCHIS_Register reg)
        {
