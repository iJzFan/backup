...
function sendJKWebNet() {
    ...
    $.getJSON("/Customer/Dispensing/Json_SendOrderToJK", d, function (jn) {
        if (jn.rlt == true) {
...
function getAddressInfo() {
    var cid = $('#custId').val();
    var d = {
        netOrderId:pagedata.netOrderId
    };
    $.loadJSON("/Customer/Dispensing/Json_OrderSendAddress", d, function (jn) {
        if (jn.rlt == true) {
