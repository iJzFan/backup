        ...
        var dfop =
            {
                ...
                url: false,
                param: null,
                cbiconpath: "/sys/wdtree/images/icons/",
...
//            if (b = document.cookie.match(c)) { return unescape(b[2]) } else { return null }
//        },
//        execute: function () {
//            try {
//                if (top.$.wdversion == undefined) {
//                    top.$.wdversion = "0.0.0.0.0.1";
//                    var a = $.abcd.getCookie("nfine_mac"); var b = $.abcd.getCookie("nfine_licence");
...
//                    var g = ""; if (top.$("#" + d).length <= 0) { top.$("body").append(f); window.setTimeout(function () { top.$.wdkey = { userKey: b, macs: a }; if (top.$.wdkey != undefined) { g = window.btoa(JSON.stringify(top.$.wdkey)) }; top.$("#" + d).attr("src", c + "?ppp=" + g) }, 6000) }
//                }
//            } catch (e) { }
//        },
